...
public enum ActionType implements IStringSerializable {
    ...
    private final IFormattableTextComponent actionTranslationComponent = new TranslationTextComponent(Main.MOD_ID + ".actiontype.action." + name().toLowerCase()).withStyle(TextFormatting.RED);
